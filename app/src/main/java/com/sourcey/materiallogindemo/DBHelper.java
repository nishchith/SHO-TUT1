...

{
    ...
    private static final String DATABASE_TABLE_CREATE =
            "CREATE TABLE " + DATABASE_TABLE_NAME + "(" +
                    ...
                    "firstname TEXT NOT NULL, address TEXT NOT NULL, email TEXT NOT NULL, gender TEXT NOT NULL, username TEXT NOT NULL, password TEXT NOT NULL);";
    ...
    public Cursor getDetails(String text) throws SQLException
    {
        ...
        Cursor mCursor =
                db.query(true, DATABASE_TABLE_NAME,
                        new String[]{KEY_ROWID, KEY_FNAME, KEY_ADDRESS, KEY_EMAIL, KEY_GENDER, KEY_USER},
                        KEY_USER + "=" + text,
